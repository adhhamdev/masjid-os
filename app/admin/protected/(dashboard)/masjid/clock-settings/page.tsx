import { getClockSettings, getMasjidDetails, updateClockSettings } from '@/app/actions';
...
export default async function ClockSettings() {
  ...
  return (
    <div className='min-h-screen py-8'>
      <main className='container mx-auto'>
        <form action={updateClockSettings}>
          <div className='flex justify-between items-center mb-4'>
            <h2 className='text-2xl font-semibold text-gray-800'>
              Clock Settings
            </h2>
            <Button formAction={updateClockSettings} className='bg-emerald-500 hover:bg-emerald-600 text-white'>
                  ...
                  <div className='space-y-4'>
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
                      ...
                      <div>
                        ...
                        <Select defaultValue={nightMode?.active.toString()} name='nightmode-active'>
